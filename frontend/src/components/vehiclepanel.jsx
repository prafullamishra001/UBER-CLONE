        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
               ...
               <div onClick={()=>{
                ...
                <div className=' w-1/2 ml-4 '>
                    <h4 className='font-medium text-base'>WayGo <span><i className="ri-user-3-fill"></i>4</span></h4>
            ...
            <div onClick={()=>{
              ...
              <div onClick={()=>{
                ...
                <div className=' w-1/2 ml-8 '>
                    <h4 className='font-medium text-base'>WayGo auto <span><i className="ri-user-3-fill"></i>3</span></h4>
                    <h5 className='font-medium text-sm'>3 minutes away</h5>
